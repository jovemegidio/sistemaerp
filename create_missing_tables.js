...
const tablesToCreate = [
    {
        ...
        sql: `CREATE TABLE IF NOT EXISTS nfes (
            ...
            presenca_compraçãor ENUM('0','1','2','3','4','5','9') DEFAULT '1',
            cliente_id INT,
            ...
            valor_icms_desoneração DECIMAL(15,2) DEFAULT 0,
            ...
            transportaçãora_id INT NULL,
            transportaçãora_nome VARCHAR(60),
            transportaçãora_cnpj VARCHAR(18),
            transportaçãora_ie VARCHAR(20),
            transportaçãora_endereco VARCHAR(100),
            transportaçãora_municipio VARCHAR(60),
            transportaçãora_uf CHAR(2),
