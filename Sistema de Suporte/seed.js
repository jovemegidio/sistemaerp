...
async function seed() {
    ...
    const knowledge = [
        ...
        { 
            ...
            resposta: 'Nosso atendimento funciona de segunda a sexta, das 8h as 18h. Aos sabados, das 8h as 12h.', 
            palavras_chave: 'horario,atendimento,funcionamento', 
            categoria: 'geral' 
        },
        { 
            pergunta: 'Como emitir segunda via de boleto?', 
            resposta: 'Para emitir a segunda via do boleto, acesse sua area do cliente, va em Financeiro > Boletos e clique em Segunda Via no boleto desejado.', 
        ...
        { 
            ...
            resposta: 'Acesse Meus Pedidos no menu principal, selecione o pedido desejado e clique em Rastrear. Voce vera o status atualizado da entrega.', 
